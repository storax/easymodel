...
htmlhelp_basename = 'easymodeldoc'
...
latex_documents = [
  ('index', 'easymodel.tex', u'easymodel Documentation',
...
man_pages = [
    ('index', 'easymodel', u'easymodel Documentation',
     [u'David Zuber'], 1)
]
...
texinfo_documents = [
  ('index', 'easymodel', u'easymodel Documentation',
   u'David Zuber', 'easymodel', 'One line description of project.',
   'Miscellaneous'),
]
